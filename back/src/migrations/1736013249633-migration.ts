...
export class Migration1736013249633 implements MigrationInterface {
    name = 'Migration1736013249633'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`vote_log\` (\`id\` int NOT NULL AUTO_INCREMENT, \`pinCodeId\` int NULL, \`maleId\` int NULL, \`femaleId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
